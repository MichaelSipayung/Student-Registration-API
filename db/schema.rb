...
ActiveRecord::Schema[7.1].define(version: 2024_02_23_100403) do
  ...
  create_table "pmdk_file_uploads", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_pmdk_file_uploads_on_user_id"
  end
  ...
  add_foreign_key "pmdk_file_uploads", "users"
